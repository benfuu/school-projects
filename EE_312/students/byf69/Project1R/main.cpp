...
void weirdasstest(void) {
	printf("\n\n******* Starting weirdasstest *******\n");
	char dictionary[] = "fdasfhjk\n312\nissw\n312\nso\nhardd\n$!@#$%^&*()_+~QWERTYUIOP\n"; // the dictionary can contain punctuation
	char article[] = "man this is cool i love EE 312 even though it is soooooooo harddddd $!^#%@)!)))*/';";
	spellCheck(article, dictionary);
	printf("****DONE****\n");
}

void suckuptest(void) {
	printf("\n\n******* Starting weirdasstest *******\n");
	char dictionary[] = "dfsadfhjfhhh\ncraigg\nchasee\niss\nthee\nmostt\nbeautifull\ngeniuss\ninn\nthee\nworLdd\nFdS\n"; // the dictionary can contain punctuation
	char article[] = "   %%%%%% \ndfsadfhjfhhh\nCraig Chase is the most beautiful\nperson\n     in the world\n    \n \n \n  f %%$&!#(fds";
	spellCheck(article, dictionary);
	printf(";)\n");
	printf("****i mean it****\n");
}

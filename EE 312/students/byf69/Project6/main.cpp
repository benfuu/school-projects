...
int main(void) {
	...
	Martian change5 = change(22, 3, 8);
	printf("change 5 should be 2d, 1n, 3p and is: %dd %dn %dp\n", change5.dodeks, change5.nicks, change5.pennies);

	Martian change6 = change(33, 3, 11);
	printf("change 6 should be 3d, 0n, 0p and is: %dd %dn %dp\n", change6.dodeks, change6.nicks, change6.pennies);

	change6 = change(2, 3, 11);
	printf("change 6 should be 0d, 0n, 2p and is: %dd %dn %dp\n", change6.dodeks, change6.nicks, change6.pennies);

	change6 = change(20, 3, 11);
	printf("change 6 should be 1d, 3n, 0p and is: %dd %dn %dp\n", change6.dodeks, change6.nicks, change6.pennies);

	change6 = change(21, 3, 11);
	printf("change 6 should be 1d, 3n, 1p and is: %dd %dn %dp\n", change6.dodeks, change6.nicks, change6.pennies);

	change6 = change(200, 5, 23);
	printf("change 6 should be 8d, 3n, 1p and is: %dd %dn %dp\n", change6.dodeks, change6.nicks, change6.pennies);

	change6 = change(199, 2, 3);
	printf("change 6 should be 66d, 0n, 1p and is: %dd %dn %dp\n", change6.dodeks, change6.nicks, change6.pennies);
